...
def view_trip():
    ...
    agent_executor = AgentExecutor(agent=agent, tools=[wikipedia_tool], verbose=True, handle_parsing_errors="Check your output and make sure it conforms to the expected JSON structure.")
